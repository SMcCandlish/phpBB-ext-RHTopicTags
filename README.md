...
1. Test-integration of various fixes people have worked out to get this old extension working again in phpBB 3.3.5 and later.  It has not been tested in this regard with 3.5.13 and later, nor with 3.3.4 or earlier.
2. Implementation of a variety of fixes as well as feature improvements. It has not been tested in this regard with phpBB 3.5.6 and later, nor with 3.3.4 or earlier.
...
- rxu, nou nou, and SciFiKriss1967 @ phpBB.com, for help debugging the installation (migrations files issuese).
...
- The typography in the French and Russian versions has been improved with regard to guillemets instead of English- and Spanish-style quotation marks, and other punctuation tweaks, as well as indication of Cyrillic alphabetical order in the `ru` version.
...
- Added additional sorting options in the ACP. You can now get alphanumeric (default), by usage frequency, and by database order (usually corresponding to tag age, unless DB optimzation tools have mangled the order). All of these have ascending and descending variants.
